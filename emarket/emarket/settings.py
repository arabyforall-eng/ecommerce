...
SECRET_KEY = 'django-insecure-2y-7!m!pu*s#ida4==72ucvh828xbcp0hl)&my%kabw8i5e17i'
...
# all of these for simulating sending emails (reset password)
...
EMAIL_HOST_USER = '55d49262479abf'
EMAIL_HOST_PASSWORD = '****78f4'
EMAIL_PORT = 2525
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_TIMEOUT = 15
